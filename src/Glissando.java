...
class Glissando implements Effet{
    ...
    public void remplirSequenceur( Molecule mol) throws InvalidMidiDataException{
    	...
    	Midi.glissando(60,  mol.getTimbre().timbreMIDI(), mol.getVolume(), mol.positions.get(0).temps, mol.positions.get(mol.positions.size() - 1).temps *1000, 20, (int) mol.vitesseOrd());
