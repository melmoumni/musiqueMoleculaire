...
public class FenetreParametres extends JFrame implements ActionListener{
	...
	public FenetreParametres() {
		...
		panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Donn�es d'entr�es", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JLabel lblDure = new JLabel("Dur�e souhait�e");
		 ...
		 *  Layout GroupLayout
		 *  R�alise a l'aide du plugin WindowsBuilder sur Eclipse
		 */
